...
mod tests {
    ...
    #[test]
    fn test_eea_gcd_1_inverse() {
        assert_eq!((1, -754, 127), extended_euclian_algorithm(2357, 397));
    }
    ...
    #[test]
    fn test_eea_gcd_2_inverse() {
        assert_eq!((2, 47, -9), extended_euclian_algorithm(240, 46));
    }
}
